...
public class UnifiedSearchApi {
     ...
     * @param query **Search**.  You can search by providing a keyword.  (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK. List of qualifying Throttling Policies is returned.  </td><td>  * Content-Type - The content type of the body. <br>  </td></tr>
     </table>
     */
    public okhttp3.Call searchCall(Integer limit, Integer offset, String query, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/throttling/policies/search";
     ...
     */
    public ThrottlePolicyDetailsListDTO search(Integer limit, Integer offset, String query, String ifNoneMatch) throws ApiException {
        ApiResponse<ThrottlePolicyDetailsListDTO> localVarResp = searchWithHttpInfo(limit, offset, query, ifNoneMatch);
     ...
     */
    public ApiResponse<ThrottlePolicyDetailsListDTO> searchWithHttpInfo(Integer limit, Integer offset, String query, String ifNoneMatch) throws ApiException {
        okhttp3.Call localVarCall = searchValidateBeforeCall(limit, offset, query, ifNoneMatch, null);
        Type localVarReturnType = new TypeToken<ThrottlePolicyDetailsListDTO>(){}.getType();
     ...
     */
    public okhttp3.Call searchAsync(Integer limit, Integer offset, String query, String ifNoneMatch, final ApiCallback<ThrottlePolicyDetailsListDTO> _callback) throws ApiException {
